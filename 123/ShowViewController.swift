...
class ShowViewController: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let leftBtn : UIBarButtonItem = UIBarButtonItem.init(title: "Search", style: UIBarButtonItemStyle.plain, target: self, action:#selector(leftBtnAction))
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.imageView.sd_setImage(with: URL.init(string: file.url))
        return cell
    }
